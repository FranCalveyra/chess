...
public class ProvidersTest {
    ...
    private void chessPieceTypeDoNotWork() {
        for(ChessPieceType type : ChessPieceType.values()){
            assertThrows(IllegalStateException.class, () -> pieceProvider.provideCheckersPiece(Color.WHITE, type));
            assertThrows(IllegalStateException.class, () -> pieceProvider.provideCheckersPiece(Color.BLACK, type));
        }
    }
}
