...
public class CheckersPromoter implements Promoter {
    ...
    public Board promote(BoardPosition position, PieceType type, Board context) {
        ...
        Piece pieceToPromoteTo = new CheckersPieceProvider().provideCheckersPiece(initialPiece.getPieceColour(), type);
        Piece promotedPiece =
                new Piece(
    ...
    private boolean isAnyManPromotable(Board context, Color team) {
        ...
        int rowToCheck = team == Color.BLACK ? context.getRows() - 1 : 0;
